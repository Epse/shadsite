            ...
            <td align="CENTER">
             <table id="NavigationBar10" border="0" cellspacing="0" cellpadding="0" width="960">
              <tr valign="top" align="left">
               ...
               <td width="120"><a href="../html/welkom.html" style="cursor:hand; text-decoration:none;" onMouseOver="F_loadRollover('NavigationButton2','',0);F_roll('NavigationButton2',1)" onMouseOut="F_roll('NavigationButton2',0)"><img id="NavigationButton2" name="NavigationButton2" height="20" width="120" src="../assets/images/autogen/Welkom_Hregular_2_-_kopie_1.gif" onmouseover="F_loadRollover(this,'Welkom_HRregular_3_1.gif',0)" border="0" alt="Welkom" title="Welkom"></a></td>
      ...
      <td width="960">
       <table id="Table53" border="0" cellspacing="0" cellpadding="5" width="100%" style="background-color: rgb(255,255,255); height: 32;">
        <tr style="height: 195px;">
         <td width="950">
          <p><b><img id="Picture2" height="185" width="200" src="../assets/images/shad_sh43_on_bike.jpg" vspace="0" hspace="0" align="RIGHT" border="0" alt="shad sh43 on bike" title="shad sh43 on bike"><br>Welkom op de website van Shad&nbsp;en in de technische wereld van de bagageprodukten.<br><br></b>Wandel even door de mogelijkheden op gebied van topcases, koffersets,&nbsp;bagage en comfort.<br><br>U zal versteld staan welke oplossingen wij aanreiken voor Uw&nbsp;transportbehoeften in de snel veranderende mobiliteitsomgeving. <br>Ervaar&nbsp;dat de produkten van SHAD van de beste kwaliteit zijn, met een waaier&nbsp;van toepassingen . <br><br>Schrijf U in op onze <a href="../html/newsletter.html"><span style="color: rgb(255,0,0);">newsletter</span></a> en wordt regelmatig&nbsp;op de hoogte gehouden van nieuwe verkooppunten , de allernieuwste&nbsp;produkten , trends en evoluties. <br><br><b>Niet gevonden wat U zoekt voor Uw eigen&nbsp;motor? </b><br>Geen probleem, dankzij onze jarenlange ervaring in de fabricage&nbsp;en constructie rond motorfietsen kunnen wij U mogelijks een oplossing&nbsp;aanreiken. <br>Contacteer ons !<span style="color: rgb(255,0,0);"> <a href="mailto:info@shad.be" CLASS="moz-txt-link-abbreviated">info@shad.be</a></span>.</p>
         </td>
        </tr>
       </table>
      </td>
