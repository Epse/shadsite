            ...
            <td align="CENTER">
             <table id="NavigationBar10" border="0" cellspacing="0" cellpadding="0" width="960">
              <tr valign="top" align="left">
               ...
               <td width="120"><a href="../html/play___win__.html" style="cursor:hand; text-decoration:none;" onMouseOver="F_loadRollover('NavigationButton6','',0);F_roll('NavigationButton6',1)" onMouseOut="F_roll('NavigationButton6',0)"><img id="NavigationButton6" name="NavigationButton6" height="20" width="120" src="../assets/images/autogen/Play___Win___Nregular_1_-_kopie_1.gif" onmouseover="F_loadRollover(this,'Play___Win___NRregular_1_-_kopie_1.gif',0)" border="0" alt="Play & Win !" title="Play & Win !"></a></td>
               <td width="120"><a href="../html/newsletter.html" style="cursor:hand; text-decoration:none;" onMouseOver="F_loadRollover('NavigationButton7','',0);F_roll('NavigationButton7',1)" onMouseOut="F_roll('NavigationButton7',0)"><img id="NavigationButton7" name="NavigationButton7" height="20" width="120" src="../assets/images/autogen/Newsletter_Hregular_2_-_kopie_1.gif" onmouseover="F_loadRollover(this,'Newsletter_HRregular_3_1.gif',0)" border="0" alt="Newsletter" title="Newsletter"></a></td>
      ...
      <td width="960">
       <table id="Table53" border="0" cellspacing="0" cellpadding="5" width="100%" style="background-color: rgb(255,255,255); height: 32;">
        <tr style="height: 104px;">
         <td width="470">
          <p><br><b>Wil je graag op de&nbsp;hoogte blijven van de SHAD nieuwigheden en akties, schrijf je dan in op onze nieuwsbrief. </b><br><br>Het volstaat om een mail te sturen naar<span style="color: rgb(255,0,0);"> </span><a href="mailto:info@shad.be" target="_blank"><span style="color: rgb(255,0,0);">info@shad.be</span></a> met de vraag om de nieuwsbrief te ontvangen. Je mailadres wordt bewaard en opgeslagen bij SHAD België en niet doorgegeven aan externe partners. U wordt occasioneel op de hoogte gehouden van aanbiedingen en volgende activiteiten van Shad België.</p>
         </td>
         <td width="470">
          <p><br><b>Si vous souhaitez rester au courant de nous nouvauxtés et actions, inscrivez-vous pour recevoir une lettre d&#8217;information par mail. </b><br><br>Cela suffit d&#8217;envoyer un mail à <a href="mailto:info@shad.be" target="_blank"><span style="color: rgb(255,0,0);">info@shad.be</span></a> avec la demande de recevoir le lettre d&#8217;information. Votre adresse mail sera conservé chez SHAD Belgique et ne sara pas distribué à des tiers. On vous tiendra au courant de façon occasionnel des nos offres et activités.</p>
         </td>
        </tr>
        <tr style="height: 185px;">
         <td colspan="2">
          <p style="text-align: center;"><img id="Picture2" height="185" width="200" src="../assets/images/shad_sh43_on_bike.jpg" vspace="0" hspace="0" align="TOP" border="0" alt="shad sh43 on bike" title="shad sh43 on bike">&nbsp;<img id="Picture3" height="184" width="212" src="../assets/images/colour_plates.jpg" vspace="0" hspace="0" align="TOP" border="0" alt="colour plates" title="colour plates"> <img id="Picture4" height="184" width="240" src="../assets/images/SHAD-SH50.jpg" vspace="0" hspace="0" align="TOP" border="0" alt="SHAD-SH50" title="SHAD-SH50"></p>
         </td>
        </tr>
       </table>
      </td>
